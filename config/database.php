    ...
    */
    ...
    'connections' => [
        ...
        'backup' => [
            ...
            'database'       => env('DB_BACKUP_DATABASE', 'wowsbar_backup'),
            'username'       => env('DB_BACKUP_USERNAME', 'wowsbar'),
    ...
    */
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix'  => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'wowsbar'), '_').'_'.env('APP_ENV').'_database_'),
        ],
