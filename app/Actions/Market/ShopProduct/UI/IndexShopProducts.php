 ...
 * Created: Tue, 26 Sep 2023 21:36:05 Malaysia Time, Kuala Lumpur, Malaysia
...
class IndexShopProducts extends InertiaAction
{
    private ProductCategory|Organisation|Shop $parent;
    ...
    public function inShopDepartment(ProductCategory $productCategory, ActionRequest $request): LengthAwarePaginator
    {
        $this->initialisation($request);
    ...
    public function handle(ProductCategory|Organisation|Shop $parent, $prefix = null): LengthAwarePaginator
    {
    ...
    public function tableStructure(ProductCategory|Organisation|Shop $parent, ?array $modelOperations = null, $prefix = null): Closure
    {
