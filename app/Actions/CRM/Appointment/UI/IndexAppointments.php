...
{
    private Employee|Customer|Shop|Guest|OrganisationUser $parent;
    ...
    public function handle(Shop|Customer|OrganisationUser|Employee|Guest $parent, $prefix = null): LengthAwarePaginator
    {
        $this->parent = $parent;
...
//         $queryBuilder->leftJoin('customers', 'appointments.customer_id', 'customers.id');
    ...
    public function tableStructure(Shop|Customer|OrganisationUser|Employee|Guest $parent, ?array $modelOperations = null, $prefix = null, ?array $exportLinks = null): Closure
    {
