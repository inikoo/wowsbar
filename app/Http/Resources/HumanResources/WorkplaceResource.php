...
class WorkplaceResource extends JsonResource
{
    public function toArray($request): array|Arrayable|JsonSerializable
    {
        ...
        return [
            ...
            'timezone'                                 => $workplace->timezone ? TimezoneResource::make($workplace->timezone)->getArray() : null,
            'address'                                  => $workplace->address ? AddressResource::make($workplace->address)->getArray() : null,
