...
use App\Actions\Gallery\DeleteUploadedImage;
...
Route::get('/websites/{website}', ShowPortfolioWebsite::class)->name('websites.show');
Route::get('/websites/{website}/edit', EditPortfolioWebsite::class)->name('websites.edit');
Route::get('/websites/{website}/delete', RemovePortfolioWebsite::class)->withTrashed()->name('websites.remove');
