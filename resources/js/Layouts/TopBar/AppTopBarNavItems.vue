<!--
  ...
  - Created: Mon, 03 Jul 2023 16:55:06 Malaysia Time, Pantai Lembeng, Bali, Id
...
<template>
    <Link
        ...
        :class="[route(layout.currentRoute, route().v().params).includes(route(menu.route.name)) ? 'text-orange-600' : 'text-gray-600']"
