...
// import MenuOne from '@/Components/Footer/Public/MenuOne.vue'
...
<template>
    <div class="relative ">
        <section class="relative isolate overflow-hidden bg-gray-100">
            ...
            <component :is="getMenuComponent"></component> -->
        ...
        <footer class="z-20 fixed w-screen bottom-0 right-0  text-white bg-black">
            ...
            <div class="flex justify-between">
                ...
                <!-- <div class="flex items-end flex-row-reverse text-sm">
                    <FooterTabLanguage :isTabActive="isTabActive" @isTabActive="(value) => isTabActive = value" />
                </div> -->
            </div>
        </footer>
    </div>
