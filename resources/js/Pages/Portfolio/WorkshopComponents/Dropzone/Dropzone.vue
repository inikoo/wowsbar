...
const ChangeData = (newData) =>{
  const index = files.value.findIndex((item)=>item.id == fileEdit.value.id)
  files[index] = {
    ...files[index],
...
<template>
  <div class="flex flex-grow gap-2.5">
    <div class="w-30 p-2.5 border-dashed" style="border: 1px dashed #d9d9d9;" v-if="files.length" @dragover="dragover" @dragleave="dragleave" @drop="drop">
