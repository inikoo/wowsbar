...
<template>
    <footer class="bg-gray-900 my-6" aria-labelledby="footer-heading">
        ...
        <div class="w-full px-10">
                ...
                <div :class="`grid lg:grid-cols-${data.collumn.length} xs:grid-cols-${data.collumn.length} gap-8`">
                    ...
                    <div v-if="item.type == 'link'">
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            <li v-for="link in item.data" :key="item.name">
                                <a :href="link.link" class="text-sm leading-6 text-gray-300 hover:text-white">{{ link.label }}</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
                ...
                <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; 2020 Your Company, Inc. All rightsreserved.</p>
            </div>
        </div>
    </footer>
</template>
