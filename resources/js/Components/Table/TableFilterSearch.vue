...
<template>
    <div class="group relative" :title="trans('Search on table')">
        <input
            ...
            class="appearance-none bg-white block pl-9 pr-0.5 w-0 group-focus-within:w-full group-focus-within:pr-9 text-sm rounded-md shadow-sm transition-all duration-200 ease-in-out border ring-0 ring-transparent focus:ring-0 focus:ring-transparent"
            :class="[value ? 'border-gray-500 focus:border-gray-500 text-gray-500' : 'border-gray-300 focus:border-gray-300']"
        >
