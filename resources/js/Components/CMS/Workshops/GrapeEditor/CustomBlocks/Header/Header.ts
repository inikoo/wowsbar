...
export  const headerBlock2 = () => {
  return {
    ...
    id: "header-block-2",
    content : `<body id="ixli" class="bg-gray-100">
...
<header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <div class="flex flex-wrap items-center text-base justify-center ml-auto">
            <a href="/appointment"
                class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 transition duration-300 ease-in-out">
                <span>Appointment</span>
            </a>

            <a href="/auth/login"
                class="ml-3 inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 focus-visible:ring focus-visible:ring-indigo-500 focus:outline-none transition duration-300 ease-in-out">
                <span>Log in</span>
            </a>
        </div>
  ...
  return {
    ...
    <header class="text-gray-600 body-font">
      ...
      <a class="mr-5 hover:text-gray-900">Fourth Link</a>
        ...
        <a class="flex m-auto title-font font-medium items-center text-gray-900 mb-4 md:mb-0"><img src="https://dummyimage.com/45x30" class="w-10 h-10 text-white p-2 rounded-md" alt="Description of the image"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"><span class="ml-3 text-xl">Tailblocks</span></a>
        <a href="/appointment" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 transition duration-300 ease-in-out">
  <span data-gjs-editable="false" data-gjs-removable="false">Appointment</span>
</a>
