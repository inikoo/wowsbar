export const heroBlock1 = () => {
    return {
      ...
      id: "hero-block-1",
      content : `
    <section data-id="hero-block-1" data-type="html" data-group="hero" class="wowsbar-block" gjs-row"  data-gjs-editable="false" data-gjs-droppable="false">
      <div class="relative isolate overflow-hidden bg-gray-900" data-gjs-droppable="false">
        <div aria-hidden="true" class="absolute left--calc-50--4rem- top-10 -z-10 transform-gpu blur-3xl sm:left--calc-50--18rem- lg:left-48 lg:top--calc-50--30rem- xl:left--calc-50--24rem-">
          <div class="aspect--1108-632- w--69-25rem- bg-gradient-to-r from--80caff- to--4f46e5- opacity-20" id="iqclm">
          </div>
        </div>
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-300">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.
            </p>
            <div class="mt-10 flex items-center gap-x-6">
              <a href="#" class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Get started</a>
              <a href="#" class="text-sm font-semibold leading-6 text-white">Learn more <span aria-hidden="true">→</span></a>
            </div>
          </div>
          <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
            <div class="max-w-2xl flex-none sm:max-w-5xl lg:max-w-none">
              <img src="https://tailwindui.com/img/component-images/dark-project-app-screenshot.png" alt="App screenshot" width="843" height="658" class="w-[50rem] rounded-md bg-white-5 shadow-2xl ring-1 ring-white-10"/>
            </div>
          </div>
        </div>
      </div>
...
export const heroBlock2 = () => {
  ...
  <section data-id="hero-block-2" data-type="html" data-group="hero" class="wowsbar-block gjs-row" data-gjs-editable="false">
      <div class="relative isolate" data-gjs-droppable="false">
        <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true" data-gjs-droppable="false">
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
              ...
              <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="#" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
...
export const heroBlock3 = () => {
  return {
    ...
    id: "hero-block-3",
    content : `
    <section data-id="hero-block-3" data-type="html" data-group="hero" class="wowsbar-block gjs-row"  data-gjs-editable="false">
      <div class="bg-white" data-gjs-droppable="false">
      <div class="relative" data-gjs-droppable="false">
...
export const heroBlock4 = () => {
  return {
    ...
    <div class="text-gray-600 body-font" data-gjs-droppable="false">
...
export const heroBlock5 = () => {
  return {
    ...
    id: "hero-block-5",
    content : `
    <section data-id="hero-block-5" data-type="html" data-group="hero" class="wowsbar-block gjs-row"   data-gjs-editable="false">
    <div class="bg-gray-50" data-gjs-droppable="false">
