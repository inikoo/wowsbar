export const footerBlock1 = () => {
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2020 Copyright:
    <a class="text-white" href="/">WOWSBAR</a>
  </div>
</footer>
`,
    };
    ...
    <div class="container p-4 pb-0">
      ...
      <section class="mb-4">
        ...
        <a class="btn btn-outline-light btn-floating m-1" href="#!" role="button"
          ><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#f7f7f7}</style><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"/></svg></a>
...
export const footerBlock3 = () => {
    ...
    <footer class="text-center text-lg-start bg-white text-muted">
      ...
      <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
        © 2021 Copyright:
        <a class="text-reset fw-bold" href="/">WOWSBAR</a>
      </div>
      <!-- Copyright -->
    </footer>
    <!-- Footer -->
...
export const footerBlock4 = () => {
    return {
        ...
        label: "Footer 4",
        content: `
        <footer class="text-center" style="background-color: #3f51b5" data-gjs-droppable="false">
        <!-- Grid container -->
        <div class="container" data-gjs-droppable="false">
          <!-- Section: Links -->
          <section  data-gjs-droppable="false">
            <!-- Grid row-->
        ...
        <!-- Copyright -->
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)" data-gjs-droppable="false">
          © 2020 Copyright:
