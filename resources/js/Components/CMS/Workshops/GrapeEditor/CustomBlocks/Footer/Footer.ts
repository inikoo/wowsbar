...
<footer class="text-gray-600 body-font"  data-gjs-editable="false" data-gjs-droppable="false">
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-col"  data-gjs-editable="false" data-gjs-droppable="false">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href="#">
        <img src="https://dummyimage.com/45x30" class="text-white m-4" alt="Description of the image">
        <span class="ml-3 text-xl">Wowsbar</span>
      </a>
  ...
  <div class="bg-gray-100" data-gjs-editable="false" data-gjs-droppable="false">
    <div class="container mx-auto py-4 px-5 flex flex-col sm:flex-row" data-gjs-editable="false" data-gjs-droppable="false">
      <p class="text-gray-500 text-sm text-center sm:text-left">© 2020 Wowsbar —<a href="https://twitter.com/Wowsbar" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@Wowsbar</a></p>
      <span class="inline-flex ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
...
<a href="#" class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
    <img src="https://dummyimage.com/45x30" class="text-white m-2" alt="Description of the image">
    <span class="ml-3 text-xl">Wowsbar</span>
</a>
<p class="mt-2 text-sm text-gray-500">Air plant banjo lyft occupy retro adaptogen indego</p>
</div>
    ...
    <div class="bg-gray-100" data-gjs-editable="false" data-gjs-droppable="false">
        <div class="container mx-auto py-4 px-5 flex flex-col sm:flex-row" data-gjs-editable="false" data-gjs-droppable="false">
            <p class="text-gray-500 text-sm text-center sm:text-left">© 2020 Wowsbar —<a href="https://twitter.com/Wowsbar" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@Wowsbar</a></p>
            <span class="inline-flex ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                <a href="#" class="text-gray-500"><svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path></svg></a>
...
export const footerBlock3 = () => {
  return {
    ...
    content :`
    <footer class="bg-gray-900" aria-labelledby="footer-heading"  data-gjs-editable="false" data-gjs-droppable="false">
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32"  data-gjs-editable="false" data-gjs-droppable="false">
    ...
    <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24"  data-gjs-editable="false" data-gjs-droppable="false">
