  ...
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href="#">
        <img src="https://dummyimage.com/45x30" class="w-10 h-10 text-white p-2 6t rounded-md" alt="Description of the image">
    ...
    <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-col">
        <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <a href="#" class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                <img src="https://dummyimage.com/45x30" class="w-10 h-10 text-white p-2 rounded-md" alt="Description of the image">
                <span class="ml-3 text-xl">Tailblocks</span>
            </a>
            <p class="mt-2 text-sm text-gray-500">Air plant banjo lyft occupy retro adaptogen indego</p>
        </div>
...
<nav class="list-none mb-10">
    ...
    <div class="container px-5 py-8 flex mx-auto items-center">
      <form style="margin: 0;">
        ...
        <div class="flex md:flex-nowrap justify-center items-end md:justify-start">
          ...
          <p class="text-gray-500 text-sm ml-6 md:mt-0 mt-2 sm:text-left text-center">Bitters chicharrones fanny pack<br class="lg:block hidden">waistcoat green juice</p>
        </div>
      </form>
      
      <!-- Tombol Sosial Media -->
      <span class="inline-flex lg:ml-auto lg:mt-0 mt-6 justify-end  w-auto">
        <a class="text-gray-500"><svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path></svg></a>
        <a class="ml-3 text-gray-500"><svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24"><path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path></svg></a>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto py-4 px-5 flex flex-col sm:flex-row">
      ...
      <span class="ml-auto sm:mt-0 mt-2 sm:w-auto sm:text-left text-center text-gray-500 text-sm">Enamel pin tousled raclette tacos irony</span>
    </div>
  </div>
</footer>
...
export const footerBlock4 = () => {
  return {
    ...
    content : `<footer class="bg-white" aria-labelledby="footer-heading">
