...
export const customUploadImage = (editor : Any, opt = null) =>{
    editor.Blocks.add('image', {
        ...
        label: 'Image',
        activate: true,
        content: `<span style='    width: fit-content;  height: fit-content;' data-gj-type="you-custom-component"><img style='width:100px; height:100px' src='https://place-hold.it/100x100'></img></span>`,
