...
import { getDbRef, setDataFirebase } from "@/Composables/firebase";
...
onMounted(() => {
    const editorInstance = grapesjs.init({
        ...
        storageManager: {
            ...
            remote: {
                ...
                save({ id: 'WuhqdKD4XsxAp2bt', data, pagesHtml })
                return { id: 'WuhqdKD4XsxAp2bt', data, pagesHtml };
                },
    ...
    editorInstance.BlockManager.get("icon").attributes = {
        ...editorInstance.BlockManager.get("icon").attributes,
