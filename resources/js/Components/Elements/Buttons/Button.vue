...
if (props.style == 'primary' || props.style == 'create') styleClass = 'bg-gray-700 dark:bg-gray-300/90 text-white dark:text-gray-700 hover:bg-gray-800 dark:hover:bg-gray-300'
