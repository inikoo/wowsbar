...
console.log('sshgsfdjhgsfdhgsfdasfdiu',props)
...
<template>
    <div class="py-1">
        <div class="flex gap-x-2">
            <div v-for="option in fieldData.options" @click="value = option.value" class="flex items-center justify-center bg-gray-100 rounded p-2 ring-1 ring-gray-300 cursor-pointer"
