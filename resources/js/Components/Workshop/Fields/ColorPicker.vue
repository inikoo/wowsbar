    ...
    <div>
      <Popover v-slot="{ open }" class="relative">
        <div>
          ...
          >
            <PopoverPanel v-show="open" class="absolute left-0 mt-2 w-56 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
              <div :style="{ background: color }">
                <ColorPicker theme="light" v-model="color" :sucker-hide="false" @changeColor="changeColor" style="width: 225px;"/>
              </div>
            </PopoverPanel>
          </Transition>
        </div>
