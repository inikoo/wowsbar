...
const FeOptions = [
    ...
    { name: "COZ CZ", image: "/art/payments/cod_cz.png?v=2", value: "cod_cz" },
    { name: "COD HU", image: "/art/payments/cod_hu.png?v=2", value: "cod_hu" },
    { name: "COD IT", image: "/art/payments/cod_it.png?v=2", value: "cod_it" },
    { name: "COD PL", image: "/art/payments/cod_pl.png?v=2", value: "cod_pl" },
    { name: "COD RO", image: "/art/payments/cod_ro.png?v=2", value: "cod_ro" },
    { name: "COD SK", image: "/art/payments/cod_sk.png?v=2", value: "cod_sk" },
