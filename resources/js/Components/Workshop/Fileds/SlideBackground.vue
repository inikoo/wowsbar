...
<template>
  <div class="w-fit">
    ...
    <div class="mt-1 lg:hidden">
      <div class="flex items-center">
        <div class="inline-block h-12 w-12 flex-shrink-0 overflow-hidden rounded-full" aria-hidden="true">
          <img id="avatar_mobile" class="h-full w-full rounded-full" :src="generateThumbnail(props.form.image_source)" />
        </div>
    ...
    <div class="relative hidden overflow-hidden rounded-full lg:block">
      <img class="relative h-40 w-40 rounded-full" :src="generateThumbnail(props.form.image_source)" alt="" />
