...
<template>
    <div class=" text-white" :class="positionRibbon" :ribbon-text="data?.text" :style="[data?.color ? `--ribbon-color: ${data.color}` : 'rgba(55, 65, 81, 1)']">
...
<style>
.corner-ribbon-top {
    --folded: 6px;  /* folded part */
    --ribbon-color: rgb(246, 255, 0); /* color */
    --fontSize: 16px; /* ribbon font-size */
    position: relative;
}
